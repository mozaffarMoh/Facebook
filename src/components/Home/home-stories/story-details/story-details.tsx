                ...
                >
                  ...
                  >
                    <div className="contacts-item-image">
                      {!loadedImagesArray.includes(item.id * 10) && (
                        <div className="story-image-page-posters-alt"></div>
                      )}

                      <img
                        src={item.img}
                        alt=""
                        onLoad={() => handleLoadedImage(item.id * 10)}
                      />
                    </div>
                  </div>
      ...
      <div className="flex flex-col" style={{ width: "70%", height: "100%" }}>
        ...
        <div className="story-footer ">
          ...
          <div className="footer-animations">
            <Animations reaction={handleReactionState} FlyAnimations={true} />
          </div>
        </div>
      </div>
    </div>
